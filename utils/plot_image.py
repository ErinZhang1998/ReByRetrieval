...
def plot_predicted_image(cnt, img_plot, pixel_pred_idx = None, pixel_gt_idx = None, enable_wandb = False, image_type_name='unknown', image_dir = None, sample_id='unknown', scale_pred_idx = None, scale_gt_idx = None):    
    fig = plt.figure(figsize=(10, 10))
    plt.imshow(np.asarray(img_plot))
    if not (pixel_gt_idx is None or pixel_pred_idx is None):
